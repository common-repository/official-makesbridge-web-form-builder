<div class="wrap wpmks-webform-body-wrapper">
	...
	<input type="hidden" id="admin-src-path1" value="<?php echo $siteUrl;?>" />
		<!-- <span style="background:#1BA7DC;color:#fff;"><?php echo $counterValue; ?></span> -->
	<?php if($counterValue > 10 && $isDismiss !== 'true'): ?>
	<div id="poststuff" class="mks_offer_show">
			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables ui-sortable">
					...
					<div class="postbox">
						...
						<div class="dotted">
					<h2 style="padding: 0; margin: 0 0 10px;">A small favor to ask...</h2>
					<p style="padding: 0 0 15px; margin: 0 0 20px; border-bottom: 1px dashed #ccc;">
						Please consider helping  <a target="_blank" href="https://makesbridge.com">us</a> spread the word by sharing your networks and/or leaving a review on <a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/official-makesbridge-web-form-builder">wordpress.org</a> forums 
					</p>
					<div class="one_half sharing">
						<h4>Join Makesbridge <i class="fa fa-share-alt"></i></h4>
							<p>To grow your business fast using one platform check out one of our packages which suits you. </p>
							<ul class="share">
							<li class="twitter">
								<a class="share-twitter" href="https://www.makesbridge.com/packages/" title="" target="blank">Check out</a>
							</li>
							<!-- <li class="facebook">
								<a class="share-facebook" href="//facebook.com/share.php?u=https://connekthq.com/plugins/ajax-load-more/" title="Share on Facebook" target="blank">Facebook</a>
							</li> -->
							</ul>
					</div>

					<div class="one_half mailing">
						<h4>Leave a Review <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></h4>
							<p>Good <em>or</em> bad - all reviews will help the plugin push forward and grow. </p>
							<ul class="share">
							 <li><a target="_blank" href="https://wordpress.org/support/view/plugin-reviews/official-makesbridge-web-form-builder">Write Review</a></li>
							</ul>

					</div>
			</div>
				<div style="clear:both"></div>
				<a title="Don't show me this again!" id="alm_dismiss_sharing" class="dismiss showtooltip" >×</a>
					</div>
					<!-- .postbox -->
